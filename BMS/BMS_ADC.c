...
void SetupADC(void)  //设置ADC的触发信息，SOC
{
    ...
    AdcaRegs.ADCSOC14CTL.bit.CHSEL = 14;        //SOC4 will convert pin A14
    AdcaRegs.ADCSOC4CTL.bit.ACQPS = acqps;      //sample window is 100 SYSCLK cycles
    AdcaRegs.ADCSOC4CTL.bit.TRIGSEL = 0X5;      //trigger on epwm1 SOCA
...
{
    // ADC a
    ADC_A0  = (float)AdcaResultRegs.ADCRESULT0  * ADC_Convert_Constant_A0   * ADC_Convert_Constant  - ADC_Convert_Offset_A0;    // pin A0
    ADC_A1  = (float)AdcaResultRegs.ADCRESULT1  * ADC_Convert_Constant_A1   * ADC_Convert_Constant  - ADC_Convert_Offset_A1;    // pin A1
    ADC_A2  = (float)AdcaResultRegs.ADCRESULT2  * ADC_Convert_Constant_A2   * ADC_Convert_Constant  - ADC_Convert_Offset_A2;    // pin A2
    ADC_A3  = (float)AdcaResultRegs.ADCRESULT3  * ADC_Convert_Constant_A3   * ADC_Convert_Constant  - ADC_Convert_Offset_A3;    // pin A3
    ADC_A4  = (float)AdcaResultRegs.ADCRESULT4  * ADC_Convert_Constant_A4   * ADC_Convert_Constant  - ADC_Convert_Offset_A4;    // pin A4
    ADC_A5  = (float)AdcaResultRegs.ADCRESULT5  * ADC_Convert_Constant_A5   * ADC_Convert_Constant  - ADC_Convert_Offset_A5;    // pin A5
    ADC_A14 = (float)AdcaResultRegs.ADCRESULT14 * ADC_Convert_Constant_A14  * ADC_Convert_Constant  - ADC_Convert_Offset_A14;   // pin A14
    ADC_A15 = (float)AdcaResultRegs.ADCRESULT15 * ADC_Convert_Constant_A15  * ADC_Convert_Constant  - ADC_Convert_Offset_A15;   // pin A15

    // ADC b
    ADC_B0  = (float)AdcbResultRegs.ADCRESULT0  * ADC_Convert_Constant_B0   * ADC_Convert_Constant  - ADC_Convert_Offset_B0;    // pin B0
    ADC_B1  = (float)AdcbResultRegs.ADCRESULT1  * ADC_Convert_Constant_B1   * ADC_Convert_Constant  - ADC_Convert_Offset_B1;    // pin B1
    ADC_B2  = (float)AdcbResultRegs.ADCRESULT2  * ADC_Convert_Constant_B2   * ADC_Convert_Constant  - ADC_Convert_Offset_B2;    // pin B2
    ADC_B3  = (float)AdcbResultRegs.ADCRESULT3  * ADC_Convert_Constant_B3   * ADC_Convert_Constant  - ADC_Convert_Offset_B3;    // pin B3

    // ADC c
    ADC_C2  = (float)AdccResultRegs.ADCRESULT2  * ADC_Convert_Constant_C2   * ADC_Convert_Constant  - ADC_Convert_Offset_C2;    // pin C2
    ADC_C3  = (float)AdccResultRegs.ADCRESULT3  * ADC_Convert_Constant_C3   * ADC_Convert_Constant  - ADC_Convert_Offset_C3;    // pin C3
    ADC_C4  = (float)AdccResultRegs.ADCRESULT4  * ADC_Convert_Constant_C4   * ADC_Convert_Constant  - ADC_Convert_Offset_C4;    // pin C4

    // ADC d
    ADC_D0  = (float)AdcdResultRegs.ADCRESULT0  * ADC_Convert_Constant_D0   * ADC_Convert_Constant  - ADC_Convert_Offset_D0;    // pin D0
    ADC_D1  = (float)AdcdResultRegs.ADCRESULT1  * ADC_Convert_Constant_D1   * ADC_Convert_Constant  - ADC_Convert_Offset_D1;    // pin D1
    ADC_D2  = (float)AdcdResultRegs.ADCRESULT2  * ADC_Convert_Constant_D2   * ADC_Convert_Constant  - ADC_Convert_Offset_D2;    // pin D2
    ADC_D3  = (float)AdcdResultRegs.ADCRESULT3  * ADC_Convert_Constant_D3   * ADC_Convert_Constant  - ADC_Convert_Offset_D3;    // pin D3
    ADC_D4  = (float)AdcdResultRegs.ADCRESULT4  * ADC_Convert_Constant_D4   * ADC_Convert_Constant  - ADC_Convert_Offset_D4;    // pin D4
}
